 # Analyze CAM data for part II

 *Remark: it is possible to download the complete GitHub folder and open directly the .html files in the browser*


 Laypersons cognitively and emotionally evaluated the basal attributes, forming clusters of semantically related basal attributes using our recently developed [Cognitive-Affective Map Tools](https://drawyourminds.de). The analyses contains four main files / folders: 
...
2. [additional community detection algorithms](https://github.com/FennStatistics/Article_BasalAttributes/blob/main/Analyses/part_II/02_analyses_CAMs_SBM_ECG.ipynb) - as a robustness check we applied additional community detection algorithms